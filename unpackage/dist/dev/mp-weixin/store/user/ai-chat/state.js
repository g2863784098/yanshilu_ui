    ...
    conversations: [
      {
        ...
        id: "conv-001",
        chatMode: "school",
        createdAt: 17470155e5,
        // 2025-05-12T10:05:00Z
        updatedAt: 17470158e5,
        ...
        messages: [
          ...
          },
          {
            ...
            timestamp: 17464539e5
            // 2025-05-05T14:05:00Z
          },
          {
            id: "msg-004",
            role: "AI",
            content: "建议先打好数学和编程基础，然后深入学习机器学习算法",
            timestamp: 17464545e5
            // 2025-05-05T14:15:00Z
          }
        ]
      },
      {
        ...
        id: "conv-002",
        chatMode: "career",
        createdAt: 17464539e5,
        // 2025-05-05T14:05:00Z
        updatedAt: 17464545e5,
        // 2025-05-05T14:15:00Z
        messages: [
          {
            id: "msg-003",
      ...
      },
      {
        ...
        updatedAt: 17470266e5,
        // 2025-05-12T13:10:00Z
        messages: [
          {
            id: "msg-005",
            role: "user",
      ...
      },
      {
        ...
        id: "conv-004",
        chatMode: "school",
        createdAt: 17470314e5,
        // 2025-05-12T14:30:00Z
        updatedAt: 1747032e6,
        // 2025-05-12T14:40:00Z
        messages: [
          {
            id: "msg-007",
            role: "user",
            content: "上海交通大学和复旦大学计算机专业哪个好？",
            timestamp: 17470314e5
            // 2025-05-12T14:30:00Z
          },
          {
            id: "msg-008",
      ...
      },
      {
        ...
        id: "conv-005",
        chatMode: "career",
        createdAt: 17468484e5,
        // 2025-05-10T09:00:00Z
        updatedAt: 17468493e5,
      ...
      },
      {
        ...
        id: "conv-006",
        chatMode: "general",
        createdAt: 17466828e5,
        // 2025-05-08T16:20:00Z
        updatedAt: 17466831e5,
        // 2025-05-08T16:25:00Z
        messages: [
          {
            id: "msg-011",
            role: "user",
            content: "你能推荐几本人工智能入门书籍吗？",
            timestamp: 17466828e5
            // 2025-05-08T16:20:00Z
          },
          {
            id: "msg-012",
      ...
      },
      {
        ...
        id: "conv-007",
        chatMode: "school",
        createdAt: 17458764e5,
        // 2025-04-25T11:00:00Z
        updatedAt: 1745877e6,
        // 2025-04-25T11:10:00Z
        messages: [
          {
            id: "msg-013",
            role: "user",
            content: "南京大学和东南大学的电子信息专业如何选择？",
            timestamp: 17458764e5
            // 2025-04-25T11:00:00Z
          },
          {
            id: "msg-014",
      ...
      },
      {
        ...
        id: "conv-008",
        chatMode: "career",
        createdAt: 17455374e5,
        // 2025-04-20T15:30:00Z
        updatedAt: 1745538e6,
        // 2025-04-20T15:40:00Z
        messages: [
          {
            id: "msg-015",
            role: "user",
            content: "互联网行业未来五年发展趋势如何？",
            timestamp: 17455374e5
            // 2025-04-20T15:30:00Z
          },
          {
            id: "msg-016",
...
exports.state = state;
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/store/user/ai-chat/state.js.map

...
const schoolData = new UTSJSONObject({
  "昌吉学院": [
    "学科教学（语文）[045103]",
    "学科教学（数学）[045104]",
    "材料与化工[085600]"
  ...
  "中国兵器科学研究院(西安现代控制技术研究所)": [
    "武器系统与运用工程[082601]"
  ],
  "中国兵器科学研究院(西北机电工程研究所)": [
    "火炮、自动武器与弹药工程[082603]"
  ],
  "中国兵器科学研究院(陕西应用物理化学研究所)": [
    "军事化学与烟火技术[082604]"
  ],
  "中国兵器科学研究院(西安机电信息技术研究所)": [
    "机械电子工程[080202]"
  ],
  "中国兵器科学研究院(西安应用光学研究所)": [
    "光学工程[080300]",
  ...
  mutations: {
    ...
    setSelectedSchool(state, schoolName) {
      ...
      if (schoolName) {
        ...
        common_vendor.index.__f__("log", "at pages_AI_Login_Match/components/combobox/graduate_school_major.js:76", "专业搜索引擎初始化完成，包含专业:", majorItems.length);
      }
    },
    ...
    initSchoolFuse(state) {
      ...
      state.schoolFuse = new common_vendor.Fuse(schoolItems, {
        keys: [
          { name: "name", weight: 0.7 },
          // 学校全名权重较高
          { name: "short", weight: 0.3 }
      ...
      common_vendor.index.__f__("log", "at pages_AI_Login_Match/components/combobox/graduate_school_major.js:117", "搜索引擎初始化完成，包含学校:", schoolItems.length);
    }
  },
  getters: {
    ...
    filteredSchoolList(state) {
      if (!state.schoolKeyword) {
        return Object.keys(state.schools).slice(0, 50);
      }
      if (!state.schoolFuse) {
      ...
      common_vendor.index.__f__("log", "at pages_AI_Login_Match/components/combobox/graduate_school_major.js:140", "Fuse原始结果:", keyword, results.length);
      if (results.length > 0) {
        common_vendor.index.__f__("log", "at pages_AI_Login_Match/components/combobox/graduate_school_major.js:144", "前5个结果:", results.slice(0, 5).map((r) => ({
          name: r.item.name,
          score: r.score,
          matches: r.matches
        })));
    ...
    filteredMajorList(state) {
      ...
      common_vendor.index.__f__("log", "at pages_AI_Login_Match/components/combobox/graduate_school_major.js:182", "专业搜索结果数量:", results.length, "关键词:", keyword);
      if (results.length > 0) {
        common_vendor.index.__f__("log", "at pages_AI_Login_Match/components/combobox/graduate_school_major.js:186", "专业搜索前5个结果:", results.slice(0, 5).map((r) => ({
          name: r.item.name,
          score: r.score,
...
function generateShortNames(name) {
  let shortNames = [];
  name.split("").filter((char) => /[\u4e00-\u9fa5]/.test(char)).join("");
  if (name.length >= 2) {
...
exports.GraduateStore = GraduateStore;
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/pages_AI_Login_Match/components/combobox/graduate_school_major.js.map

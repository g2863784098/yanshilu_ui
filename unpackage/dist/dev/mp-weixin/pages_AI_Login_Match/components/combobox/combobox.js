  ...
  methods: {
    ...
    onSearchInput(event = null) {
      ...
      _this.searchTimer = setTimeout(() => {
        common_vendor.index.__f__("log", "at pages_AI_Login_Match/components/combobox/combobox.vue:429", "发送搜索请求:", _this.searchKeyword);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    j: common_vendor.sei("r0-6af05d89", "view", "dropdownTrigger"),
    ...
    q: common_vendor.sei("r1-6af05d89", "scroll-view", "scrollView"),
